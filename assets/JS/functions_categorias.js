...
// y si existe ejecuta el script
    if (document.querySelector("#foto")) {
      ...
      foto.onchange = function (e) {
        //se efecuta cuando el input cambia de valor
        ...
        if (uploadFoto != "") {
          ...
          if (
            ...
            //validacion de los formatos de imagen
            ...
            document.querySelector(".prevPhoto div").innerHTML =
              "<img id='img' src=" + objeto_url + ">"; //ruta temporal
          }
        } else {
    ...
    if (request.readyState == 4 && request.status == 200) {
      ...
      if (objData != "") {
        ...
        document.querySelector("#imgCategoria").innerHTML =
          '<img src="' + objData.url_portada + '"></img>';
    ...
    if (request.readyState == 4 && request.status == 200) {
      ...
      if (objData != "") {
        ...
        if (document.querySelector("#img")) {
          ...
          document.querySelector(".prevPhoto div").innerHTML =
            '<img id="img" src="' + objData.url_portada + '"></img>';
        }
...
function removePhoto() {
  ...
  document.querySelector(".prevPhoto div").innerHTML =
    '<img id="img" src="assets/img/uploads/categorias.png">';
}
